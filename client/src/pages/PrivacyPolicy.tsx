      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80 mb-3">We collect, but do not save information you provide directly to us, including:</p>
            <ul className="list-disc pl-6 text-foreground/80 mb-3 space-y-1">
              ...
              <li>None of this information is saved/accessible to staff</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80 mb-3">
              ...
              You can delete your account at any time, and your data will be removed immediately.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80 mb-3">
              FemConnect is not available to users under 18 years of age. Our verification process requires users to send
              a picture of their photo ID (with everything except their birthday covered for privacy). Thus, we do not collect data from anyone under 18.
            </p>
          </section>
